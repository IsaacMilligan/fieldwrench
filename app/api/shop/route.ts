...
import {
  ...
  deleteBookableServiceAction,
  reorderBookableServiceAction,
...
const OPS: Record<string, (form: FormData) => Promise<unknown>> = {
  ...
  delete_bookable_service: deleteBookableServiceAction,
  reorder_bookable_service: reorderBookableServiceAction,
